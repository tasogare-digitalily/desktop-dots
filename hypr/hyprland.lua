...
-- remember_window_size=no: otherwise kitty reopens maximized if the last kitty closed was
hl.bind(mainMod .. " + SHIFT + RETURN", hl.dsp.exec_cmd(terminal .. " --class kitty-float -o remember_window_size=no"))
