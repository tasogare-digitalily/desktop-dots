...
wofi_command = f"echo '{output}' | wofi --show=dmenu --hide-scroll --allow-markup --define=hide_search=true --location=top_right --width=200 -L {len(sinks)} --xoffset=-60 -s ~/.config/waybar/scripts/audio.css"
